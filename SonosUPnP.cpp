...
TrackInfo SonosUPnP::getTrackInfo(IPAddress speakerIP, char *uriBuffer, size_t uriBufferSize, char *title, size_t titleSize, char *artist, size_t artistSize) {
  TrackInfo trackInfo;
...
void SonosUPnP::ethClient_stringWithin(const char *begin, size_t beginSize, const char *end, size_t endSize, char *resultBuffer, size_t resultBufferSize) {
   int matchIndex = 0;
